...
def visualize(tree, xsize = 10, ysize = 10, title = "Quad Tree Visualization", save_plot = False, file_name = "plot.png"):
    ...
    def draw_lines(node):
        ...
        pyplot.plot([bb.min_x, bb.max_x], [node.center.y, node.center.y], color="black", linewidth=1.5)

        # Draw vertical line at center.x from min_y to max_y
        pyplot.plot([node.center.x, node.center.x], [bb.min_y, bb.max_y], color="black", linewidth=1.5)
